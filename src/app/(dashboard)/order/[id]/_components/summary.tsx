...
export default function Summary({order, orderMenu, id}: {
    order: {
            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <p className="text-sm">{convertUSD(totalPrice)}</p>
                    </div>
                    <div className="flex justify-between items-center">
                        <p className="text-sm">Tax (12%)</p>
                        <p className="text-sm">{convertUSD(tax)}</p>
                    </div>                   
                    <div className="flex justify-between items-center">
                        <p className="text-sm">Service (5%)</p>
                        <p className="text-sm">{convertUSD(service)}</p>
                    </div>
                    <Separator/>
                    <div className="flex justify-between items-center">
